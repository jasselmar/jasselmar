      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Mobile & Web Development specialist",
            "url": "https://jorgemar.me",
            "sameAs": [
              "https://www.linkedin.com/in/jorgemar2022/",
              "https://github.com/jasselmar"
            ],
            "skills": ["React Native", "React", "TypeScript", "JavaScript", "Python", "AWS", "Firebase"]
          })
        }}
      />
      <Header />
        ...
        <div className="w-full px-4 sm:px-0 sm:w-[90%] md:w-[80%] lg:max-w-[70%] min-h-screen py-8" >
          <section className="sm:mt-36 mt-24 rounded-3xl bg-darkGreen p-4 pb-5 sm:p-8 relative overflow-hidden mb-20">
            ...
            <div className='mt-10 w-[100%] relative flex xl:flex-row flex-col gap-5' >
              <aside className='flex xl:flex-col flex-col-reverse gap-5' >
                <section className='rounded-[1.25rem] border-t border-orange-50 px-3 py-3 shadow-stone-800/30 backdrop-blur-2xl border-opacity-15 bg-stone-800 bg-opacity-80 pointer-events-auto shrink-0 shadow-2xl shadow-stone-900/80 xl:w-[25.5rem] '>
                  <h2 className={`${circular.className} text-xl text-orange-50 px-3`} >Education</h2>
                  <ul className='px-3'>
                ...
                <section className='rounded-[1.25rem] border-t border-orange-50 px-3 py-3 shadow-stone-800/30 backdrop-blur-2xl border-opacity-15 bg-stone-800 bg-opacity-80 pointer-events-auto shrink-0 shadow-2xl shadow-stone-900/80 xl:w-[25.5rem]'>
                  <h2 className={`${circular.className} text-xl text-orange-50 px-3`} >Experience</h2>
                  <ul className='px-3'>
                    <li className='flex flex-col justify-start py-4' >
                      <div className='flex flex-row justify-start gap-4' >
                        <div className='flex flex-row items-center' >
              ...
              <section className='flex flex-col rounded-[1.25rem] w-full border-t border-orange-50 px-3 py-5 shadow-stone-800/30 backdrop-blur-2xl border-opacity-15 bg-stone-800 bg-opacity-80 pointer-events-auto shadow-2xl shadow-stone-900/80' >
                <h2 className={`${circular.className} text-xl text-orange-50 px-3 pb-5`} >Projects</h2>
